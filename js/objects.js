...
var person = {
    ...
    bio: function () {
        return `The intersests of ${this.name.firstName} ${this.name.lastName}, of age ${this.age}, of gender ${this.gender} are ${this.interests}.`;
    }
};
console.log(person);
...
output.textContent = person.name.firstName[0];
